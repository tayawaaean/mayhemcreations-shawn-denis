 ...
 */
router.post('/', sessionAuthenticate, requireRole(['admin', 'seller']), createVariant);
 ...
 * @access Private (Admin/Seller only)
 */
router.put('/:id', sessionAuthenticate, requireRole(['admin', 'seller']), updateVariant);
 ...
 * @access Private (Admin/Seller only)
 */
router.delete('/:id', sessionAuthenticate, requireRole(['admin', 'seller']), deleteVariant);
 ...
 * @access Private (Admin/Seller only)
 */
router.put('/:id/inventory', sessionAuthenticate, requireRole(['admin', 'seller']), updateVariantInventory);
