...
const mockRefundRequests: RefundRequest[] = [
  ...
  },
  {
    ...
    description: 'The quality is much lower than shown in the photos.',
    images: [],
    status: 'rejected',
    requestedAt: new Date('2024-01-18T16:45:00Z'),
    processedAt: new Date('2024-01-19T11:30:00Z'),
    adminNotes: 'Rejected - product matches description, customer changed mind'
  }
]
